...
| P18 | Two replicas performing the same reunion at different local rounds minted different residue ids and never converged | The rendezvous round is part of the agreed reunion input (`Input::ReunionRequested { round, .. }`), not local state. |
